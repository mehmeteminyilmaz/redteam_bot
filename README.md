...
## Desteklenen MITRE ATT&CK Teknikleri ve Vektörler
...
| **T1041** | Exfiltration | Exfiltration Over C2 Channel (Burst & Slow) | Hızlı veya Low-and-Slow gizli veri aktarımı |
...
- `redteam_attacks.json` - Her saldırının teknik bilgileri, hedef IP adresleri, başlangıç/bitiş süreleri ve ham sonuçlarını içeren JSON kaydı
